...
class KukaHydrostaticGripper(RobotBase):
  '''
  ...
  def initialize(self):
    ''''''
    ur5_urdf_filepath = os.path.join(self.root_dir, 'simulators/urdf/kuka/kuka_with_hydrostatic_gripper.sdf')
    # ur5_urdf_filepath = '/home/colin/Research/helping_hands_rl_envs/helping_hands_rl_envs/simulators/urdf/kuka/kuka_with_hydrostatic_gripper.sdf'
  ...
  def closeGripper(self, max_it=100, primative=constants.PICK_PRIMATIVE):
    ''''''
    # if primative == constants.PULL_PRIMATIVE: #TODO BUG w constants
    #   force = 20
    # else:
    #   force = 10
    force = 10
  ...
  def _getGripperJointPosition(self):
    ...
    p2 = pb.getJointState(self.id, 9)[0]
    return p1, p2
