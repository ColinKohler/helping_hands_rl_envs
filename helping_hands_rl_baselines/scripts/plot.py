...
if __name__ == '__main__':
  ...
  log_filepaths = [
    '/home/colin/hdd/workspace/midichlorians/data/block_pulling_corner/new_3/log_data.pkl',
    '/home/colin/hdd/workspace/ysalamir/data/block_pulling_corner/finger_force/log_data.pkl',
    '/home/colin/hdd/workspace/ysalamir/data/block_pulling_corner/no_finger_force/log_data.pkl',
  ]
  #log_names = ['vison+force', 'vision']
  log_names = ['force_scalar', 'force_image', 'vision']
