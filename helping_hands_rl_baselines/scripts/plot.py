...
if __name__ == '__main__':
  ...
  log_filepaths = [
    '/home/colin/hdd/workspace/midichlorians/data/block_pulling_corner/new_force_enc_3/log_data.pkl',
    '/home/colin/hdd/workspace/ysalamir/data/block_pulling_corner/new_fingers_2/log_data.pkl',
  ]
