...
from helping_hands_rl_envs.envs.tilt_house_building_2_env import createTiltHouseBuilding2Env
...
from helping_hands_rl_envs.envs.tilt_improvise_house_building_2_env import createTiltImproviseHouseBuilding2Env
...
from helping_hands_rl_envs.envs.tilt_improvise_house_building_6_env import createTiltImproviseHouseBuilding6Env
...
from helping_hands_rl_envs.envs.tilt_improvise_house_building_2_deconstruct_env import createTiltImproviseHouseBuilding2DeconstructEnv
...
def createEnvs(num_processes, runner_type, simulator, env_type, env_config, planner_config={}):
  ...
  elif env_type == 'tilt_house_building_2':
    envs = [createTiltHouseBuilding2Env(parent_env, env_configs[i]) for i in range(num_processes)]
  elif env_type == 'tilt_house_building_3':
    envs = [createTiltHouseBuilding3Env(parent_env, env_configs[i]) for i in range(num_processes)]
  elif env_type == 'tilt_house_building_4':
    envs = [createTiltHouseBuilding4Env(parent_env, env_configs[i]) for i in range(num_processes)]
  elif env_type == 'tilt_improvise_house_building_2':
    envs = [createTiltImproviseHouseBuilding2Env(parent_env, env_configs[i]) for i in range(num_processes)]
  ...
  elif env_type == 'tilt_improvise_house_building_6':
    envs = [createTiltImproviseHouseBuilding6Env(parent_env, env_configs[i]) for i in range(num_processes)]
  ...
  elif env_type == 'tilt_house_building_3_deconstruct':
    envs = [createTiltHouseBuilding3DeconstructEnv(parent_env, env_configs[i]) for i in range(num_processes)]
  elif env_type == 'tilt_house_building_4_deconstruct':
    envs = [createTiltHouseBuilding4DeconstructEnv(parent_env, env_configs[i]) for i in range(num_processes)]
  elif env_type == 'tilt_improvise_house_building_2_deconstruct':
    envs = [createTiltImproviseHouseBuilding2DeconstructEnv(parent_env, env_configs[i]) for i in range(num_processes)]
  ...
  elif env_type == 'tilt_improvise_house_building_6_deconstruct':
